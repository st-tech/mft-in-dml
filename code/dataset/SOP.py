# Adapted from https://github.com/tjddus9597/Proxy-Anchor-CVPR2020/tree/master/code/dataset/SOP.py
import os
...
class SOP(BaseDataset):
    def __init__(self, root, mode, transform=None):
        ...
        metadata = open(
            os.path.join(
                self.root,
                ("Ebay_train.txt" if self.classes == range(0, 11318) else "Ebay_test.txt"),
            )
        )
